Instructions
    <ul>
        <li>
            ...
            <ul>
                <li>Go to the <a href="[[./releases](https://github.com/saijapesh/OSD-On_Screen_Display/releases/tag/V1.0)](https://github.com/saijapesh/OSD-On_Screen_Display/releases/tag/V1.0)">releases page</a> of this repository.</li>
